...
<div class="cart-container">
	...
	<?php foreach($items->result() as $item) {
		...
		$finalUrl = 'http://en.yiwugo.com/ywg/productdetail.html?account=Wien.suh@gmail.com&productId='.$item->PRODUCT_ID;
		...
		<div class="col-2 col-md-3">
			<div class="row">
				...
				<?php elseif($obj['detail']['sdiProductsPriceList'] == null):
					//FORMAT THE PRICE
					$tmpPrice = $this->incube->setPrice($convertRate, $marginParameter, $item->PRODUCT_PRICE);
				?>
				<div class="d-flex justify-content-center">
				...
				<?php
					...
					$currentPrice = $this->incube->getCorrectPrice($convertRate, $marginParameter, $totalItems, $obj['detail']['sdiProductsPriceList']);
				?>
