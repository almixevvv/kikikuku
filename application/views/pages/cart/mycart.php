								...
								<div class="d-md-none d-lg-block d-xl-block">
									<div class="row">
										<div class="col-lg-12 col-xl-12">
											<div class="d-flex justify-content-center">
												<span class="font-weight-bold"><?php echo ($price == 0 ? 'Price Negotiable' : 'IDR ' . number_format($price, 2, ',', '.')); ?></span>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="col-12 cart-product-separator pb-4">
						...
						<div class="row">
							<div class="col-12">
								...
								<div class="row mt-2">
									<div class="col-12">
										<span><?php echo ($price == 0 ? 'Price Negotiable' : 'IDR ' . number_format($price, 2, ',', '.')); ?></span>
									</div>
								</div>
							</div>
						</div>
