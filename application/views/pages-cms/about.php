          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <table id="subscription_table" name="subscription_table" class="table table-striped table-bordered bootstrap-datatable">
                ...
                <?php foreach($about->result() as $dt){
                ...
                <td>
                  ...
                  data-about='<?php echo $aboutt; ?>'>edit</button>
          ...
          <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <textarea name="text-aboutt" id="form10" class="md-textarea form-control modal-about" rows="10"><?php echo $aboutt; ?></textarea>
